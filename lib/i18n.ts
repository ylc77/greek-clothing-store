...
export const text = {
  el: {
    ...
    intro: "Επιλεγμένα κομμάτια μόδας, παπούτσια, τσάντες και αξεσουάρ. Ασφαλής online πληρωμή με Viva και παραλαβή από BOX NOW Locker ή το κατάστημα.",
    latest: "Νέα προϊόντα",
    ...
    step2Title: "Επιλέξτε",
    step2Desc: "Επιλέξτε χρώμα, μέγεθος και ποσότητα από το διαθέσιμο απόθεμα.",
    step3Title: "Παραγγείλτε",
    step3Desc: "Πληρώστε με ασφάλεια μέσω Viva και επιλέξτε BOX NOW Locker ή παραλαβή από το κατάστημα.",
    step4Title: "Παραλάβετε",
    step4Desc: "Παρακολουθήστε την κατάσταση και παραλάβετε από το Locker ή το κατάστημα.",
    ...
    whyOnline: "Ασφαλής online παραγγελία",
    whyOnlineDesc: "Το απόθεμα μεγέθους και χρώματος ελέγχεται πριν γίνει δεκτή η παραγγελία.",
    ...
    relatedProductsText: "Ανακαλύψτε παρόμοια κομμάτια που μπορεί να σας αρέσουν.",
  ...
  en: {
    eyebrow: "Athens boutique",
    intro: "Selected fashion pieces, shoes, bags and accessories. Pay securely with Viva and collect from a BOX NOW Locker or our store.",
    ...
    step2Title: "Choose",
    step2Desc: "Choose a color, size and quantity from current available stock.",
    step3Title: "Order",
    step3Desc: "Pay securely with Viva and choose a BOX NOW Locker or free store pickup.",
    step4Title: "Receive",
    step4Desc: "Follow the order status and collect from the Locker or our store.",
    browseCollection: "Browse collection",
    whyUs: "Why choose us",
    whyLocal: "Local Athens Store",
    whyLocalDesc: "Visit our physical boutique in Athens.",
    whyOnline: "Safe online ordering",
    whyOnlineDesc: "Size and color availability is checked before your order is accepted.",
    ...
    relatedProductsText: "Explore similar pieces you may also like.",
