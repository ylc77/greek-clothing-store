...
export const text = {
  el: {
    ...
    intro: "Επιλεγμένα κομμάτια μόδας, παπούτσια, τσάντες και αξεσουάρ. Παραγγείλτε online με αντικαταβολή ή παραλαβή από το κατάστημα.",
    latest: "Νέα προϊόντα",
    ...
    step3Desc: "Ολοκληρώστε την παραγγελία σας με αντικαταβολή ή παραλαβή από το κατάστημα.",
    step4Title: "Παραλάβετε",
    step4Desc: "Παρακολουθήστε την κατάσταση και πληρώστε κατά την παράδοση ή την παραλαβή.",
  ...
  en: {
    eyebrow: "Athens boutique",
    intro: "Selected fashion pieces, shoes, bags and accessories. Order online with cash on delivery or store pickup.",
    ...
    step3Title: "Order",
    step3Desc: "Checkout with cash on delivery or pay when collecting in store.",
    step4Title: "Receive",
    step4Desc: "Follow the order status and pay on delivery or collection.",
