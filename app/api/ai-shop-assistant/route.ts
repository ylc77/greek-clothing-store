...
export async function POST(request: NextRequest) {
  ...
  const storeInfo = {
    ...
    cash_on_delivery: settings.online_store_enabled && settings.delivery_enabled ? "available" : "unavailable",
    store_pickup: settings.online_store_enabled && settings.pickup_enabled ? "available" : "unavailable",
    shipping_fee_eur: settings.delivery_enabled ? settings.shipping_fee : null,
    free_shipping_threshold_eur: settings.free_shipping_threshold,
    delivery_instructions: language === "en" ? settings.delivery_instructions_en : settings.delivery_instructions_gr,
